...
#'@param show.line,show.points,show.lr.eta,show.sens,show.AUC logical Arguments to be passed to plot_ROC()
...
makePPTxList_ROC=function(yvar="male",xvars=c("weight","height","age"),dataname="radial",
                          ...
                          show.points=TRUE,show.lr.eta=TRUE,show.sens=TRUE,
                          show.AUC=TRUE){
     ...
     if(multiple){
          ...
          if(separate){
               for(i in 1:no){
                  ...
                  type=c(type,"ggplot")
                  temp=paste0("plot_ROC(ROC(form=",yvar,"~",xvars[i],",data=",dataname,",plot='')",
                              ",show.line=",show.line,
                              ",show.points=",show.points,
                              ",show.lr.eta=",show.lr.eta,
                              ",show.sens=",show.sens,
